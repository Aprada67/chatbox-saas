...
const T = {
  en: {
    ...
    cancelNo: 'Keep it',
    cancelSuccess:
      'Done! Your appointment has been cancelled. A confirmation email has been sent.',
  ...
  es: {
    ...
    cancelNo: 'Mantenerla',
    cancelSuccess:
      '¡Listo! Tu cita fue cancelada. Te enviamos un email de confirmación.',
  ...
  pt: {
    ...
    cancelNo: 'Manter',
    cancelSuccess:
      'Pronto! Sua consulta foi cancelada. Enviamos um email de confirmação.',
  ...
  fr: {
    ...
    checkSlots: (date) =>
      `Laissez-moi vérifier la disponibilité pour ${date}...`,
    ...
    cancelNo: 'Conserver',
    cancelSuccess:
      'Fait ! Votre rendez-vous a été annulé. Un email de confirmation a été envoyé.',
  ...
  const botMsg = (text, delay = 0) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setMessages((p) => [
          ...p,
          { from: 'bot', text, id: Date.now() + Math.random() },
        ]);
      }, 700);
    }, delay);
  };
        ...
        >
          ...
          >
            {[
              ...
              {
                label: 'Duration',
                value: `${booking.service?.durationMins} min`,
              },
              {
                label: 'Date',
