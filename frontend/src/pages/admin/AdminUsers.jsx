            ...
            >
              ...
              <div className="p-4 flex items-center justify-between gap-3">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  {/* Avatar con inicial */}
                  <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 text-sm font-semibold text-white"
                       style={{ background: user.isActive ? 'var(--accent)' : 'var(--text-3)' }}>
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-medium truncate"
                       style={{ color: user.isActive ? 'var(--text-1)' : 'var(--text-3)' }}>
                      {user.name}
                    </p>
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  <span className="text-xs font-medium px-2.5 py-1 rounded-full capitalize hidden sm:inline"
                        style={{
                  ...
                  >
                    <motion.div animate={{ rotate: expandedId === user.id ? 180 : 0 }}>
                      <ChevronDown size={14} />
                    </motion.div>
                  </button>
                </div>
              ...
              <AnimatePresence>
                {expandedId === user.id && (
                  ...
                  >
                    <div className="px-4 pb-4 pt-0 border-t flex flex-col sm:flex-row gap-3"
                      ...
                      <div className="flex-1 pt-3 flex flex-col gap-1">
                        ...
                        {user.trialEndsAt && (
                          <p className="text-xs" style={{ color: 'var(--text-3)' }}>
                            Trial ends: {new Date(user.trialEndsAt).toLocaleDateString('en-US', {
                              year: 'numeric', month: 'short', day: 'numeric'
                            })}
                          </p>
                        )}
                      ...
                      <div className="flex flex-col gap-2 sm:items-end pt-3">
                        ...
                        <select
                          value={user.plan}
                          onChange={e => planMutation.mutate({ id: user.id, plan: e.target.value })}
